...
* `PREDICATE_SHOW_ALL_SOURCES` -- when the user does not pass an argument to the list command,
and hence all sources are displayed
* `targetIndex` -- the number N upto which the most recent sources are to be displayed to the user
