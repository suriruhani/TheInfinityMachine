...
* Parameters can be in any order e.g. if the command specifies `n/TITLE p/TYPE`, `p/TYPE n/TITLE` is also acceptable.
====
...
Format: `edit INDEX [i/TITLE] [y/PHONE] [d/EMAIL] [t/TAG]...`
