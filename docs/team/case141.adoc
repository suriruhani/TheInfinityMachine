...
** What it does: A recycle bin mode that allows users to revisit, retrieve and restore all previously deleted sources. Preceding restore commands can be reversed by using the redo command.
