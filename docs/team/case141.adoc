...
** What it does: A recycle bin mode that allows users to safely delete from the source manager, revisit, retrieve and restore all previously deleted sources. Preceding restore commands can be reversed by using the redo command.
