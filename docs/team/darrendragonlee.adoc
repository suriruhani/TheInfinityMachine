...
** Community:
*** Offered technical assistance to team mates by providing in depth code analysis for pull requests (Pull request https://github.com/CS2103-AY1819S2-W13-3/main/pull/128[#128], https://github.com/CS2103-AY1819S2-W13-3/main/pull/203[#203])
