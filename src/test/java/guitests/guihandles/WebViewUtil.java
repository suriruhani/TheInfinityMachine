...
public class WebViewUtil {
    ...
    /**
     * If the {@code sourcePanelHandle}'s {@code WebView} is loading, sleeps the thread till it is successfully loaded.
     */
    public static void waitUntilBrowserLoaded(SourcePanelHandle sourcePanelHandle) {
        new GuiRobot().waitForEvent(sourcePanelHandle::isLoaded);
    }
}
